  ...
  return (
    <div className="grid grid-cols-12 px-10 my-10 lg:px-32 lg:gap-20">
      <div className="col-span-12 lg:col-span-8">
        ...
        <div className="flex border-[1.5px] border-black px-4 py-4  rounded-sm my-10">
          <Package />
        ...
        <input
          className="w-full border-[#E5E5E5] rounded-md mb-4 px-4 py-3 border-[2px] placeholder"
          type="text"
        ...
        />
        <input
          className="w-full border-[#E5E5E5] rounded-md px-4 py-3 border-[2px] placeholder"
          type="text"
        ...
        <input
          className="w-full border-[#E5E5E5] rounded-md my-4 px-4 py-3 border-[2px]"
          type="text"
          placeholder="Address Line 2"
        />
        <input
          className="w-full border-[#E5E5E5] rounded-md mb-4 px-4 py-3 border-[2px]"
          type="text"
        ...
        <div className="flex gap-4">
          <select
            className="w-full border-[#E5E5E5] rounded-md mb-4 px-4 py-3 border-[2px] text-[#8D8D8D]"
        ...
        <div className="mt-12">
          ...
          >
            ...
            accordance with the Privacy Statement and Cookie Policy. eShopWorld
        ...
        <div>
          <h3 className="pt-4 pb-8 border-t-[1px] font-semibold border-[#E5E5E5]">
            Delivery
          </h3>
          <h3 className="pt-4 pb-8 border-t-[1px] border-[#E5E5E5] text-text-primary-gray">
            Shipping
          </h3>
          <h3 className="pt-4 pb-8 border-t-[1px] border-[#E5E5E5] text-text-primary-gray">
            Billing
